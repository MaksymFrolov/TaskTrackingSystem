...
namespace DataAccessLayer.DataBase.Repositories
{
    ...
    public class GenericRepository1<T> : IRepository1<T> where T : BaseEntity
    {
        protected private readonly TaskDbContext dbContext;

        /// <summary>Initializes a new instance of the <see cref="GenericRepository11{T}" /> class.</summary>
        /// <param name="dbContext">The database context.</param>
        public GenericRepository1(TaskDbContext dbContext)
        {
