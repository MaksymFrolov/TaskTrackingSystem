...
namespace BuisnessLogicLayer.Services
{
    ...
    public class UserService1 : IUserService1
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="UserService1" /> class.</summary>
        /// <param name="roleManager">The role manager.</param>
        /// <param name="userManager">The user manager.</param>
        /// <param name="unitOfWork1">The unit of work.</param>
        /// <param name="mapper">The mapper.</param>
        public UserService1(RoleManager<IdentityRole<int>> roleManager,
            UserManager<User> userManager,
            IUnitOfWork1 unitOfWork1,
            IMapper mapper,
        ...
        {
            var list = (await _unitOfWork1.UserProjectRepository1
